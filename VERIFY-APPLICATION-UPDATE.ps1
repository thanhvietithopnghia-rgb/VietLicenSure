...
try {
    ...
    Assert-UpdateTest ($script:ToolUpdateToolVersion -eq '5.0.0.2') 'Updater foundation version is invalid.'
    ...
    $manifest = [pscustomobject][ordered]@{
        ...
        ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0.0.2'
        DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0.0.2/VietLicenSure-v5.0.exe'
        DownloadSha256 = ('A' * 64)
        DownloadSize = 65536
    ...
    Assert-UpdateTest ($candidate.LatestVersion -eq '5.0.0.2' -and $candidate.Title -eq 'Test release VI') 'Manifest result or localization is invalid.'
    ...
    $currentManifest.LatestVersion = '5.0.0.2'
    $currentManifest.MinimumUpdaterVersion = '4.6.1.0'
    $currentManifest.ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0.0.2'
    $currentManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0.0.2/VietLicenSure-v5.0.exe'
    $current = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0.0.2' -SelectedCulture 'en-US'
    ...
    $sameBuild = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0.0.2' -InstalledSha256 ('A' * 64) -SelectedCulture 'en-US'
    ...
    $replacementBuild = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0.0.2' -InstalledSha256 ('B' * 64) -SelectedCulture 'vi-VN'
    ...
    Assert-UpdateThrows { ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0.0.2' -InstalledSha256 'INVALID' | Out-Null } 'An invalid installed executable SHA-256 was accepted.'
    ...
    $older = ConvertFrom-ToolUpdateManifest -Manifest $olderManifest -InstalledVersion '5.0.0.2' -InstalledSha256 ('B' * 64) -SelectedCulture 'vi-VN'
    ...
    $upgradeManifest.LatestVersion = '5.0.0.2'
    $upgradeManifest.MinimumUpdaterVersion = '4.6.2.0'
    $upgradeManifest.ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0.0.2'
    $upgradeManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0.0.2/VietLicenSure-v5.0.exe'
    $upgradeCandidate = ConvertFrom-ToolUpdateManifest -Manifest $upgradeManifest -InstalledVersion '4.6.2.0' -SelectedCulture 'vi-VN'
    Assert-UpdateTest ([bool]$upgradeCandidate.UpdateAvailable -and [bool]$upgradeCandidate.CanSelfUpdate) 'v4.6.2 cannot self-update to v5.0.0.2.'
    ...
    $badManifest.DownloadUrl = 'https://example.com/releases/download/v5.0.0.2/VietLicenSure-v5.0.exe'
    ...
    $badAssetManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0.0.2/Other-Tool.exe'
    ...
    Assert-UpdateThrows { Assert-ToolUpdateReleaseUri ([uri]'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0.0.2?x=1') | Out-Null } 'A release URL with a query was accepted.'
    ...
    $deniedArguments = "-NoProfile -ExecutionPolicy RemoteSigned -File `"$updateManagerPath`" -Mode Check -CurrentVersion 5.0.0.2 -ResultFile `"$deniedResultPath`""
    ...
    $developmentDeniedArguments = "-NoProfile -ExecutionPolicy RemoteSigned -File `"$updateManagerPath`" -Mode Check -ConsentGranted -CurrentVersion 5.0.0.2 -ResultFile `"$developmentDeniedResultPath`""
    ...
    $installResult = Install-ToolUpdateExecutable -StagedPath $stagedPath -TargetPath $targetPath -TargetSha256 $newSha256 -InstalledVersion '4.8.0.1' -TargetVersion '5.0.0.2' -CacheDirectory $cacheDirectory -SkipRestart
    ...
    Assert-UpdateTest ($launcherText.Contains('"Tool-UpdateManager.ps1"') -and $launcherText.Contains('TOOL_LAUNCHER_PID') -and $launcherText.Contains('TOOL_TOOL_VERSION"] = "5.0.0.2"') -and $launcherText.Contains('TOOL_SIGNED_STABLE_BUILD') -and $launcherText.Contains('TOOL_MANAGED_SIGNED_BUILD') -and $launcherText.Contains('TOOL_STORE_BUILD') -and $launcherText.Contains('TOOL_SELF_UPDATE_ALLOWED')) 'Launcher does not embed or pin the v5.0.0.2 update foundation.'
