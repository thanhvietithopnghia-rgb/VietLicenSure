...
try {
    ...
    Assert-UpdateTest ($script:ToolUpdateToolVersion -eq '5.0') 'Updater foundation version is invalid.'
    ...
    $manifest = [pscustomobject][ordered]@{
        ...
        ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0'
        DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0/VietLicenSure-v5.0.exe'
        DownloadSha256 = ('A' * 64)
        DownloadSize = 65536
    ...
    Assert-UpdateTest ($candidate.LatestVersion -eq '5.0' -and $candidate.Title -eq 'Test release VI') 'Manifest result or localization is invalid.'
    ...
    $currentManifest.LatestVersion = '5.0'
    $currentManifest.MinimumUpdaterVersion = '4.6.1.0'
    $currentManifest.ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0'
    $currentManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0/VietLicenSure-v5.0.exe'
    $current = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0' -SelectedCulture 'en-US'
    ...
    $sameBuild = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0' -InstalledSha256 ('A' * 64) -SelectedCulture 'en-US'
    ...
    $replacementBuild = ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0' -InstalledSha256 ('B' * 64) -SelectedCulture 'vi-VN'
    ...
    Assert-UpdateThrows { ConvertFrom-ToolUpdateManifest -Manifest $currentManifest -InstalledVersion '5.0' -InstalledSha256 'INVALID' | Out-Null } 'An invalid installed executable SHA-256 was accepted.'
    ...
    $older = ConvertFrom-ToolUpdateManifest -Manifest $olderManifest -InstalledVersion '5.0' -InstalledSha256 ('B' * 64) -SelectedCulture 'vi-VN'
    ...
    $upgradeManifest.LatestVersion = '5.0'
    $upgradeManifest.MinimumUpdaterVersion = '4.6.2.0'
    $upgradeManifest.ReleasePageUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0'
    $upgradeManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0/VietLicenSure-v5.0.exe'
    $upgradeCandidate = ConvertFrom-ToolUpdateManifest -Manifest $upgradeManifest -InstalledVersion '4.6.2.0' -SelectedCulture 'vi-VN'
    Assert-UpdateTest ([bool]$upgradeCandidate.UpdateAvailable -and [bool]$upgradeCandidate.CanSelfUpdate) 'v4.6.2 cannot self-update to v5.0.'
    ...
    $badManifest.DownloadUrl = 'https://example.com/releases/download/v5.0/VietLicenSure-v5.0.exe'
    ...
    $badAssetManifest.DownloadUrl = 'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/download/v5.0/Other-Tool.exe'
    ...
    Assert-UpdateThrows { Assert-ToolUpdateReleaseUri ([uri]'https://github.com/thanhvietithopnghia-rgb/VietLicenSure/releases/tag/v5.0?x=1') | Out-Null } 'A release URL with a query was accepted.'
    ...
    $deniedArguments = "-NoProfile -ExecutionPolicy RemoteSigned -File `"$updateManagerPath`" -Mode Check -CurrentVersion 5.0 -ResultFile `"$deniedResultPath`""
    ...
    $developmentDeniedArguments = "-NoProfile -ExecutionPolicy RemoteSigned -File `"$updateManagerPath`" -Mode Check -ConsentGranted -CurrentVersion 5.0 -ResultFile `"$developmentDeniedResultPath`""
