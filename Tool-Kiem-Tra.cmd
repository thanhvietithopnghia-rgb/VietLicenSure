...
if exist "%~dp0Tool-Kiem-Tra-v4.9.exe" goto RUN_ROOT
if exist "%~dp0dist\Tool-Kiem-Tra-v4.9.exe" goto RUN_DIST
goto SOURCE_MODE
...
:RUN_ROOT
start "" /wait "%~dp0Tool-Kiem-Tra-v4.9.exe"
exit /b %ERRORLEVEL%

:RUN_DIST
start "" /wait "%~dp0dist\Tool-Kiem-Tra-v4.9.exe"
exit /b %ERRORLEVEL%
