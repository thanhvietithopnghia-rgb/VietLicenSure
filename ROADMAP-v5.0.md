...
3. Chạy EXE đóng gói có chủ đích trên ma trận máy sạch với tài khoản thường/admin, có/không Office, Offline/Online; lưu artifact cho UAC, report, update, backup, cancel/crash và rollback.
