...
Phiên bản áp dụng: **v5.0 ManagedSigned / Internal Pilot**
...
- Chỉ kênh Public Stable dùng chứng thư CA công cộng mới bật self-update; `ManagedSigned / Internal Pilot` dùng `ManagedDeployment` và không đọc public Stable manifest để tự thay thế.
