...
Assert-Enterprise ($enterpriseUiText -match '"5\.0\.0\.2"') 'Enterprise UI thiếu fallback v5.0.0.2.'
...
try {
    ...
    Assert-Enterprise ([string]$metadata.ToolVersion -eq "5.0.0.2") "Enterprise ToolVersion không phải 5.0.0.2."
    ...
    $validation = Test-ToolReportEnvelope -Report $report -ExpectedReportKind "EnterpriseInventory" -ExpectedToolVersion "5.0.0.2"
    ...
    SchemaVersion="1.0"; ToolVersion="5.0.0.2"; ClientId=$client.ClientId; ComputerName="VERIFY-CLIENT"
